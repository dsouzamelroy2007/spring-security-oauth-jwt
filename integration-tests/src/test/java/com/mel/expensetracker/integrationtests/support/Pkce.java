...
/**
 * RFC 7636 code_verifier / code_challenge (S256) pair for driving a PKCE flow
 * in tests. Local copy of authorization-server's own test-only helper: no
 * module in this reactor produces a test-jar, so cross-module test code can't
 * depend on another module's src/test/java classes.
 */
